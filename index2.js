...
const main = async () => {
    socket.on("open", async () => {
        ...
        let result = await res.send(JSON.stringify(rpcObject));
...
// var jsonrpc = async function(url, onopen, onclose, onnotification) {
...
//   if (onopen) {
//     onopen();
//     let request = {"jsonrpc":"2.0", "id": 1, "method": "sui_subscribeEvent", "params": [{"All":[{"Package":"0x26d943059b2c6420671bc7c66b3e72b8532f0e7f"}]}]}
//     ws.send(JSON.stringify(request));
//     console.log('sent', request);
//     let res = await resolveRequest(ws);
//     console.log(`respons rpc: ${res}`);
// };
// //   return {
// //     close: () => ws.close(),
